...
**FallOptom · sovereign single-file UK optometry practice OS** — sovereign SDK extracted from `falloptom/index.html`.

## Install
```bash
npm install @ai-native-solutions/falloptom-sdk
```

## Use
```js
import * as falloptom from '@ai-native-solutions/falloptom-sdk';
```

- Playground: https://sjgant80-hub.github.io/falloptom-sdk/
- MCP wrapper: [`@ai-native-solutions/falloptom-mcp`](https://github.com/sjgant80-hub/falloptom-mcp)
- HTTP API: [`@ai-native-solutions/falloptom-api`](https://github.com/sjgant80-hub/falloptom-api)
...
- **Discoverable** — indexed on the FallMarket catalog at [sjgant80-hub.github.io/fallmarket/listing.html?id=falloptom-sdk](https://sjgant80-hub.github.io/fallmarket/listing.html?id=falloptom-sdk)
...
- **Companion SDK** (`npm install @ai-native-solutions/falloptom-sdk-sdk`) — programmatic JavaScript API for direct integration.
- **Companion MCP server** (`claude mcp add falloptom-sdk -- npx -y @ai-native-solutions/falloptom-sdk-mcp`) — Model Context Protocol server that any Claude/Cursor/Codex client can invoke as a tool.
- **Companion HTTP API** (`docker run --rm ghcr.io/sjgant80-hub/falloptom-sdk-api`) — containerized REST endpoint for language-agnostic access.
...
- **Registry entry**: https://sjgant80-hub.github.io/fallmarket/listing.html?id=falloptom-sdk
- **Live URL**: https://sjgant80-hub.github.io/falloptom-sdk/
- **Source**: https://github.com/sjgant80-hub/falloptom-sdk
